   ...
   async (req, res) => {
      ...
      try {
         ...
         if (!errors.isEmpty()) {
            ...
            if (user) {
               return apiResponse.validationErrorWithData(res, "User already exists with this email or phone", errors.array());
            }
...
exports.userList = [
   ...
   function (req, res) {
      try {
         Users.find()
            .select("fullname designation organization fathername mobile email aadhar dateofbirth createdAt")
            .then((userstatus) => {
